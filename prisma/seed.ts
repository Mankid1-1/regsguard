...
async function main() {
  ...
  const regulations = [
    // ─── MN Plumbing ───
    {
      ...
      portalUrl: "https://www.dli.mn.gov/business/plumbing-and-mechanical-contractors",
      fee: "$50",
    ...
    // ─── MN Electrical ───
    {
      ...
      officialEmail: null,
      portalUrl: "https://www.dli.mn.gov/business/electrical-contractors",
      fee: "$60",
    ...
    // ─── CE Requirements ───
    {
      ...
      authority: "MN DLI",
      officialEmail: "dli.license@state.mn.us",
      portalUrl: "https://www.dli.mn.gov/business/get-licenses-and-permits/continuing-education-licensees",
      fee: null,
      renewalCycle: "ANNUAL" as const,
