...
export const noticeToOwnerTemplate: DocumentTemplate = {
  ...
  fields: [
    ...
    { key: "ownerName", label: "Property Owner Name", type: "text", required: true, section: "Owner" },
    { key: "ownerAddress", label: "Owner Mailing Address", type: "text", required: true, section: "Owner" },
    { key: "propertyAddress", label: "Property Address (where work performed)", type: "text", required: true, section: "Property" },
    { key: "propertyCounty", label: "County", type: "text", required: true, section: "Property" },
    { key: "propertyState", label: "State", type: "text", required: true, section: "Property" },
