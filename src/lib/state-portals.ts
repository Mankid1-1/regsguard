...
export const STATE_PORTALS: StatePortal[] = [
  // ─── MINNESOTA ───
  {
    ...
    actions: [
      { type: "RENEW", label: "Renew plumbing license", url: "https://www.dli.mn.gov/business/plumbing-and-mechanical-contractors" },
      { type: "LOOKUP", label: "Look up MN plumbing license", url: "https://www.dli.mn.gov/license-and-registration-lookup" },
      ...
      { type: "FORMS", label: "Plumbing forms", url: "https://www.dli.mn.gov/business/license-forms-permits-plan-review-and-local-governments" },
  ...
  },
  {
    ...
    authority: "MN Department of Labor and Industry (DLI)",
    actions: [
      { type: "RENEW", label: "Renew electrical license", url: "https://www.dli.mn.gov/business/electrical-contractors" },
      { type: "LOOKUP", label: "Look up MN electrical license", url: "https://www.dli.mn.gov/license-and-registration-lookup" },
      ...
      { type: "FORMS", label: "Electrical forms", url: "https://www.dli.mn.gov/business/license-forms-permits-plan-review-and-local-governments" },
  ...
  },
  {
    ...
    authority: "MN Department of Labor and Industry (DLI)",
    actions: [
      { type: "RENEW", label: "Renew HVAC license", url: "https://www.dli.mn.gov/business/plumbing-and-mechanical-contractors" },
      { type: "LOOKUP", label: "Look up MN HVAC license", url: "https://www.dli.mn.gov/license-and-registration-lookup" },
      { type: "FORMS", label: "HVAC forms", url: "https://www.dli.mn.gov/business/license-forms-permits-plan-review-and-local-governments" },
    ],
  },
  {
    state: "MN",
    ...
    authority: "MN Department of Labor and Industry (DLI)",
    actions: [
      { type: "RENEW", label: "Renew residential building contractor license", url: "https://www.dli.mn.gov/business/residential-contractors-remodelers-roofers" },
      { type: "LOOKUP", label: "MN contractor license lookup", url: "https://www.dli.mn.gov/license-and-registration-lookup" },
      ...
      { type: "FORMS", label: "Contractor forms", url: "https://www.dli.mn.gov/business/license-forms-permits-plan-review-and-local-governments" },
